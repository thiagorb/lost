module Lost {
    ...
    export class StarsManager implements Game.Renderable {
        ...
        constructor(
            private readonly MIN_Z,
            private readonly MAX_Z,
            private readonly Z_LAYERS,
        ...
        iterateStorage<T>(storage: MapperStorage<T>, coord: number, z: number, callback: (t: T, i: number) => any)
        {
    ...
    export class Projector
    {
        ...
        from(i: number, x: number, z: number)
        {
